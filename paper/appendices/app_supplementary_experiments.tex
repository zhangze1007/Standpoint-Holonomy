...
\paragraph{Status.}
This measurement is computationally inexpensive and can be completed on CPU.
Results for GPT-2 (144 heads) and Llama-2-7b (1024 heads) will be reported in
a subsequent revision. The measurement code is available in
\texttt{experiments/experiment\_a\_baseline\_ensemble.py} (value matrix
orthonormality module).
