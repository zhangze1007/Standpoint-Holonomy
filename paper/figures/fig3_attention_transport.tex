...
\end{tikzpicture}
\caption{%
    \textbf{Curvature as path-dependence of attention transport.}
    ...
    The curvature~$F_{ijk} = U_{ij} \cdot U_{jk} \cdot (U_{ik}^{\exp})^{-1}$ measures
    the failure of these two paths to agree.
