...
\caption{%
    ...
    connection~$A_\Psi$, and holonomy deviation~$F$ on the standpoint bundle.
    The five-layer standpoint model (middle) instantiates the fiber as a direct sum of
    psychologically grounded subspaces~$\psi_k$, interpreted as a diagnostic projection
    coordinate system.
    ...
    connection to attention weights~$\alpha$, and holonomy deviation to path-dependence of
    composite transport.
