...
by a distinct curvature signature across layers and scenario types. The taxonomy is
organized into four groups of three, corresponding to four dimensions of standpoint
...
\begin{tabular}{@{}clll@{}}
\toprule
\textbf{ID} & \textbf{Name} & \textbf{Primary Layer} & \textbf{Curvature Signature} \\
\midrule
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{soc}} \gg 0$ for triangles
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{soc}} \gg 0$ with secondary
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{mor}}$ shows a monotonic increase
across the conversation. Individual curvature values may be small, but the cumulative
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\min} \gg 0$. The minimal self's transport
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{pos}} \gg 0$ with secondary
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{mor}} \gg 0$ with secondary
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{nar}} \gg 0$. The narrative layer's
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{nar}} \gg 0$ with secondary
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\min} \gg 0$. The minimal self's
...
\textbf{Curvature signature:} $\|F_{ijk}\|_{\mathrm{pos}} \gg 0$. The positional
...
\textbf{Curvature signature:} $\sum_{k \in K} \|F_{ijk}\|_k \gg 0$. All layers show
elevated curvature simultaneously, indicating a global failure of standpoint transport.
...
with measured block-specific curvatures $\{\|F_{ijk}\|_k\}$, the failure mode is
identified by which layers show elevated curvature and in which temporal pattern. The
...
\begin{enumerate}
    ...
    \item Match the curvature pattern to the taxonomy
