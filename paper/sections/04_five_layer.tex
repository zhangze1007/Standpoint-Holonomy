...
research in psychology and cognitive neuroscience. The five layers are mathematically
independent subspaces of the fiber (Lemma~\ref{lem:decomposition} guarantees block-specific
curvature decomposition), but functionally layered: $\psi_{\mathrm{min}}$ provides the
