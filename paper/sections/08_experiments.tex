...
\textbf{Status} \\
\midrule
H1a & Block sensitivity & Above-mean ratio & [to be filled] & [to be filled] &
Pending \\
...
\midrule
\multirow{6}{*}{Llama-7b}
& T0 & 30 & [to be filled] & [to be filled] & [to be filled] \\
& T1 & 30 & [to be filled] & [to be filled] & [to be filled] \\
& T2 & 30 & [to be filled] & [to be filled] & [to be filled] \\
& T3 & 30 & [to be filled] & [to be filled] & [to be filled] \\
& T4 & 30 & [to be filled] & [to be filled] & [to be filled] \\
& T5 & 30 & [to be filled] & [to be filled] & [to be filled] \\
\bottomrule
\end{tabular}

\medskip
{\footnotesize Values to be computed from the holonomy deviation pipeline output.
SD = standard deviation; IQR = interquartile range (Q3$-$Q1).
95\% confidence intervals for median differences between scenario types are reported in
