...
\begin{enumerate}
    ...
    curvature tensor onto each standpoint subspace (Definition~\ref{def:binding-failure}):
    \[
...
The dynamic non-commutativity (Proposition~\ref{prop:cross-term}) predicts that high curvature
