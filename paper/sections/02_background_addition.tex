...
\emph{what information a layer contains}. Curvature answers a complementary
question: \emph{whether that information is preserved across events}. A layer
can have high probing accuracy (it encodes the right commitment) yet high
curvature (it fails to transport that commitment consistently). The two
diagnostics are orthogonal: probing measures representational content, curvature
measures transport fidelity. A complete diagnostic requires both.
